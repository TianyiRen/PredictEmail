...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EmailAddress', fields ['email']
        db.create_unique(u'predict_emailaddress', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailAddress', fields ['email']
        db.delete_unique(u'predict_emailaddress', ['email'])
    ...
    models = {
        u'predict.emailaddress': {
            ...
            'email': ('django.db.models.fields.CharField', [], {'max_length': '256', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
